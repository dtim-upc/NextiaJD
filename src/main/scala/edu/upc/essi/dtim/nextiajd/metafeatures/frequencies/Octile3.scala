...
object Octile3 extends MetaFeature with Quantile{

  val name: String = "frequency_3qo"
  val nameAtt: String = "frequency_3qo"
  ...
  val doc: String = "Third octile of the frequency distribution count"

  val value: Double = 0.375
}
