...
object Octile7 extends MetaFeature with Quantile{

  val name: String = "frequency_7qo"
  val nameAtt: String = "frequency_7qo"
  ...
  val doc: String = "Seven octile of the frequency distribution count"

  val value: Double = 0.875
}
