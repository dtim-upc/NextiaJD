...
object CardinalityAlphanumeric extends MetaFeature {

  val name: String = "numberAlphanumeric"
  val nameAtt: String = "PctAlphanumeric"
  ...
  val doc: String = "Number of alphanumeric tuples"
