...
object Octile4 extends MetaFeature with Quantile{

  val name: String = "frequency_4qo"
  val nameAtt: String = "frequency_4qo"
  ...
  val doc: String = "Forth octile of the frequency distribution count"
